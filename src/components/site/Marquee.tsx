...
export function Marquee() {
  ...
  return (
    <div className="relative w-full overflow-hidden border-y border-black/10 bg-background">
      <div
        className={`marquee-track flex whitespace-nowrap py-4 ${!isPlaying ? "marquee-paused" : ""}`}
